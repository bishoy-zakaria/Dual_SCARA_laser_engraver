...
def System_Simulation():
    ...
    print("e1: ",format(mean_absolute_error(Data_ideal, Data_1) , 'f'))
    print("e2: ",format(mean_absolute_error(Data_ideal, Data_2) , 'f'))
    print("e3: ",format(mean_absolute_error(Data_ideal, Data_3) , 'f'))
    print("e4: ",format(mean_absolute_error(Data_ideal, Data_4) , 'f'))
